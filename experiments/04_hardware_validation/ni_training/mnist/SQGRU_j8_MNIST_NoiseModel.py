...
class SQGRU:
    ...
    def __subCell__(self, X, hidden, params, key=None):
        ...
        alpha_matrix = jnp.array([
            [0.8762, 0.8893],  # Z0(✓), X0(未校準)
            [0.9059, 0.8893],  # Z1(✓), X1(未校準)
            [0.8893, 0.8893],  # Z2(未校準), X2(未校準)
            [0.8893, 0.8893],  # Z3(未校準), X3(未校準)
            [0.8466, 0.8681],  # Z4(✓), X4(✓)
            [0.8707, 0.9294],  # Z5(✓), X5(✓)
            [0.8744, 0.9410],  # Z6(✓), X6(✓)
            [0.8575, 0.9230],  # Z7(✓), X7(✓)
        ...
        K_matrix = jnp.array([
            [0.0270, 0.0314],  # Z0(✓), X0(未校準)
            [0.0243, 0.0314],  # Z1(✓), X1(未校準)
            [0.0314, 0.0314],  # Z2(未校準), X2(未校準)
            [0.0314, 0.0314],  # Z3(未校準), X3(未校準)
            [0.0306, 0.0238],  # Z4(✓), X4(✓)
            [0.0307, 0.0350],  # Z5(✓), X5(✓)
            [0.0236, 0.0458],  # Z6(✓), X6(✓)
            [0.0365, 0.0372],  # Z7(✓), X7(✓)
