...
class SQGRU:
    ...
    def __subCell__(self, X, hidden, params, key=None):
        ...
        # add noise
        # alpha_matrix: OTC calibrated (fake backend)
        # K_matrix: K_vec_v6, uncalibrated qubits use mean K=0.036
        alpha_matrix = jnp.array([
            [0.5786, 0.6185],  # Z0(✓), X0(未校準)
            [0.6852, 0.6185],  # Z1(✓), X1(未校準)
            [0.6185, 0.6185],  # Z2(未校準), X2(未校準)
            [0.6185, 0.6185],  # Z3(未校準), X3(未校準)
            [0.5659, 0.5545],  # Z4(✓), X4(✓)
            [0.5231, 0.7709],  # Z5(✓), X5(✓)
            [0.5831, 0.6925],  # Z6(✓), X6(✓)
            [0.5365, 0.6953],  # Z7(✓), X7(✓)
        ...
        K_matrix = jnp.array([
            [0.0581, 0.0530],  # Z0(✓), X0(未校準)
            [0.0838, 0.0530],  # Z1(✓), X1(未校準)
            [0.0530, 0.0530],  # Z2(未校準), X2(未校準)
            [0.0530, 0.0530],  # Z3(未校準), X3(未校準)
            [0.0452, 0.0737],  # Z4(✓), X4(✓)
            [0.0492, 0.0602],  # Z5(✓), X5(✓)
            [0.0351, 0.0342],  # Z6(✓), X6(✓)
            [0.0620, 0.0283],  # Z7(✓), X7(✓)
